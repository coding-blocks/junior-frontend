  ...
  <div class="row">
    <div class="col-md-6">
      ...
      <div class="heading-6 my-40 text-grey">
        <VMarkdown :markdown="course.description" />
      </div>
      <button class="button-primary" @click="setShowSyllabusModal(true)">
        ...
        <div class="card">
          ...
          >
            <div class="flex-1 d-sm-block d-none">
              <div class="heading-5 bold mb-10">
    ...
    <Modal v-if="showSyllabusModal" @close="setShowSyllabusModal(false)">
      <CourseSyllabusModal :course="course" />
    </Modal>
  </div>
</template>
<script>
