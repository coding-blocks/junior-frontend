  ...
  <div>
    ...
    <ul class="list-divided mt-4">
      <li class="lectures flex items-center px-4 py-3" v-for="lecture in lectures" :key="lecture.id">
        ...
        <div> 
          <nuxt-link class="button-solid button-orange mx-auto" :to="`lectures/${lecture.id}`"> Edit</nuxt-link>
        </div>
      </li>
    </ul>
    <nuxt-link class="button-solid button-orange mx-auto mt-4" to="lectures/add"> Create Lecture </nuxt-link>
  </div>
</template>
